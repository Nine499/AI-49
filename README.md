...
### 1. cf49raw - GitHub 文件代理工具

位于 `JavaScript/cf49raw/` 目录下，用于代理访问 GitHub 上的原始文件。
...
2. 粘贴 [cf49raw.js](JavaScript/cf49raw/cf49raw.js) 内容
3. 设置环境变量 `NINE49TOKEN` 和 `GITHUB49TOKEN`
4. 部署项目

或者使用 Vercel 部署:

1. 将 [JavaScript/cf49raw/](JavaScript/cf49raw/) 目录作为根目录部署到 Vercel
...
### 5. download_wenku8_novels - 轻小说下载工具
...
### 6. processing_cosplay_files - Cosplay 文件处理工具
...
### 7. convert_html_entities_in_file - HTML 实体转换工具
...
- 前端: 无
- 后端: Python 脚本 + CloudFlare Worker (JavaScript)
- 数据库: 无
- 其他依赖:
